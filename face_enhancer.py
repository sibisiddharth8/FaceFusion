...
supported_enhancers = {
    "GFPGAN": ("model/GFPGANv1.4.pth", gfpgan_runner),
    "REAL-ESRGAN 2x": ("model/PreTrainedRealESRGAN_x2.pth", realesrgan_runner),
    "REAL-ESRGAN 4x": ("model/RealESRGAN_x4.pth", realesrgan_runner),
    "REAL-ESRGAN 8x": ("model/RealESRGAN_x8.pth", realesrgan_runner)
}
